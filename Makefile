...
HTTPS_GIT := https://github.com/AkilaChain/akila.git
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/AkilaChain/akila"
	godoc -http=:6060
...
PACKAGE_NAME:=github.com/AkilaChain/akila
