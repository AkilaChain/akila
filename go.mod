module github.com/AkilaChain/akila
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/AkilaChain/cosmos-sdk v0.47.5-akila.2
	// use Akila geth fork
	github.com/ethereum/go-ethereum => github.com/AkilaChain/go-ethereum v1.10.26-akila-rc2
